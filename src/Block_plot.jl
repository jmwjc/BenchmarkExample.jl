...
@inline function generateGeo(lc = 1.0)
    ...
    gmsh.model.addPhysicalGroup(2, [Γ1,Γ2,Γ3,Γ4], -1, "Γ1")

    gmsh.model.addPhysicalGroup(2, [Γ5,Γ6,Γ7,Γ8], -1, "Γ2")
    gmsh.model.addPhysicalGroup(2, [Γ9,Γ10], -1, "Γ3")
    gmsh.model.addPhysicalGroup(2, [Γ11,Γ12], -1, "Γ4")
    gmsh.model.addPhysicalGroup(2, [Γ13,Γ14], -1, "Γ5")
    gmsh.model.addPhysicalGroup(2, [Γ15,Γ16], -1, "Γ6")
    gmsh.model.addPhysicalGroup(2, [Γ17,Γ18], -1, "Γ7")
    gmsh.model.addPhysicalGroup(2, [Γ19,Γ20], -1, "Γ8")
